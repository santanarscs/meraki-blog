...
export default function Home() {
  return (
    <div>
      ...
      <section className="bg-gray-200 content-area flex items-center justify-between px-3 sm:px-8 w-full text-gray-800">
      ...
      <section className="py-4 sm:py-14 bg-white px-3 sm:px-8 w-full text-gray-800 flex items-center flex-col">
      ...
      <section className="py-4 sm:py-14 bg-gray-200 px-3 sm:px-8 w-full text-gray-800 flex items-center flex-col">
      ...
      <section className="py-4 sm:py-14 bg-white px-3 sm:px-8 w-full text-gray-800 flex items-center flex-col">
        ...
        <div className="flex flex-col items-center sm:flex-row sm:justify-between mt-6">
      ...
      <footer className="bg-brand text-white">
        <div className="flex flex-col sm:flex-row py-4 sm:py-14 px-3 sm:px-8 w-full justify-between">
