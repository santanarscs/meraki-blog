...
export default function Home() {
  return (
    <div>
      ...
      <section className="bg-gray-200 content-area flex items-center justify-between px-8 w-full text-gray-800">
        <div className="flex flex-col items-end">
          <h1 className="text-4xl tracking-wide font-semibold mb-2">Oi, eu sou Ana Caroline</h1>
          <span className="text-brand font-medium text-2xl mb-4">Auriculoterapia e bem estar</span>
          <button className="bg-brand p-4 rounded-full text-white uppercase tracking-wide w-36 font-medium hover:bg-brand-dark transition-colors">Saiba mais</button>
        </div>
        <div>
      ...
      <section className="p-14 bg-white px-8 w-full text-gray-800 flex items-center flex-col">
        <h1 className=" text-4xl uppercase tracking-wider font-medium pb-2 border-b-2 border-brand">Serviços</h1>
        <ul className="grid grid-cols-3 gap-4 mt-6">
          <li className="rounded-lg shadow-md overflow-hidden bg-white">
            <img className="h-80 w-full object-cover" src="/images/aurico.jpeg" alt="Auriculoterapia" />
          ...
          <li className="rounded-lg shadow-md overflow-hidden bg-white">
            <img className="h-80 w-full object-cover" src="/images/ventosa.jpeg" alt="Ventosa terapia" />
            <div className="p-4 flex flex-col">
          ...
          <li className="rounded-lg shadow-md overflow-hidden bg-white">
            <img className="h-80 w-full object-cover" src="/images/coach_child.jpeg" alt="Coach Child education" />
            <div className="p-4 flex flex-col">
      ...
      <section className="p-14 bg-gray-200 px-8 w-full text-gray-800 flex items-center flex-col">
        <h1 className="text-4xl uppercase tracking-wider font-medium pb-2 border-b-2 border-brand">Meus Clientes</h1>
      ...
      <section className="p-14 bg-white px-8 w-full text-gray-800 flex items-center flex-col">
        <h1 className=" text-4xl uppercase tracking-wider font-medium pb-2 border-b-2 border-brand">Sobre mim</h1>
        <div className="flex justify-between mt-6">
          <img className="border-4 border-brand w-1/3" src="/images/Carol.jpeg" alt="Carol Santana"/>
          <div className="ml-4 flex-1 text-gray-600 space-y-6">
      ...
      <section className="p-14 bg-gray-200 px-8 w-full text-gray-800 flex items-center flex-col">
        <h1 className="text-4xl uppercase tracking-wider font-medium pb-2 border-b-2 border-brand">Contato</h1>
        <div className="flex mt-6">
          <form className="w-2/3">
            ...
            <button className="bg-brand text-white rounded-full w-32 px-4 py-2 uppercase">enviar</button>
          </form>
          <div className="flex flex-col  ml-4">
            <img src="/images/MAPA.png" alt="Localização" />
            <p className="self-end text-gray-700 mt-3">R. Acerbal Pinto Malheiros, 82A - Mariléa Chácara, Rio das Ostras</p>
            <p className="self-end text-gray-700">Telefone: (22) 98324-2230</p>
          </div>
        </div>
      </section>
      <footer className="bg-brand text-white">
        <div className="flex p-14 px-8 w-full justify-between">
          <div className="flex items-center">
            <img src="/images/logo-white.svg" alt="Meraki terapia" />
